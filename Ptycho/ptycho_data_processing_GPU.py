...
from ptypy.accelerate.cuda_pycuda.engines import DM_pycuda, ML_pycuda
...
p.engines.engine00.name = "DM_pycuda"             ## Engine name
...
p.engines.engine01.name = 'ML_pycuda'            ## parameters for Maximum Likehood engine
